if SERVER then
    ...
    resource.AddFile("materials/models/codbo2/other/rc-xd/mtl_veh_t6_rcxd_wheels.vmt")
    resource.AddFile("materials/models/codbo2/other/rc-xd/mtl_veh_t6_rcxd_wheels2.vmt")
    resource.AddFile("materials/models/codbo2/other/rc-xd/mtl_veh_t6_rcxd_wheels_n.vtf")
