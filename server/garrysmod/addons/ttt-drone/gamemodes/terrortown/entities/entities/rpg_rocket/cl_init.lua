...
function ENT:Think()
        ...
        if ( self.Emitter ) then
                        ...
                        for i=0, Length, 8 do
                                ...
                                if math.random(3) > 1 then
                                        ...
                                        particle:SetVelocity( VectorRand() * 40*rescalepart ) 
                                        particle:SetLifeTime( 0 ) 
                                        particle:SetDieTime( math.Rand(1.0,1.5)*rescalepart ) 
                                        particle:SetStartAlpha( math.Rand(150,200) ) 
                                        particle:SetEndAlpha( 0 ) 
                                        particle:SetStartSize( math.random(5,10)*rescalepart ) 
                                        particle:SetEndSize( math.random(20,50)*rescalepart ) 
                                ...
                                if math.random(3) == 3 then
                                        ...
                                        particle:SetVelocity( (VectorRand() * 30 + Vector(0,0,20))*rescalepart ) 
                                        particle:SetLifeTime( 0 ) 
                                        particle:SetDieTime( math.Rand(0.1,0.2)*rescalepart ) 
                                        particle:SetStartAlpha( 255 ) 
                                        particle:SetEndAlpha( 0 ) 
                                        particle:SetStartSize( math.random(6,12) *rescalepart) 
                                        particle:SetEndSize( 1 *rescalepart) 
        ...
        if ( dlight ) then
                ...
                dlight.g = 230
                dlight.b = 200  
                dlight.Brightness =  math.Rand( 0.8, 1.0 )
                dlight.Decay = 128
