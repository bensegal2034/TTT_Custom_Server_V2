if SERVER then
	...
	resource.AddFile("materials/vgui/entities/tfa_raygun.vtf")
	...
	resource.AddFile("materials/models/weapons/raygun/~-gzombie_teleport_glow_c.vmt")
	resource.AddFile("materials/models/weapons/raygun/battery_c.vmt")
	resource.AddFile("materials/models/weapons/raygun/ray_gun.vmt")
	resource.AddFile("materials/models/weapons/raygun/ray_gun_n.vtf")
	resource.AddFile("materials/models/weapons/raygun/ray_gun_o.vtf")
	resource.AddFile("materials/models/weapons/raygun/weapon_red_dot_c.vmt")
