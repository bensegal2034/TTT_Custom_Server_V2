...
if SERVER then
self.Owner:EmitSound( self.Primary.Sound, SNDLVL_94dB, 100, 1, CHAN_WEAPON )
end
...
if self.Weapon:Ammo1() > self.Primary.MaxClip then
self.Owner:SetAmmo( self.Primary.MaxClip, self.Primary.Ammo )
end
end
