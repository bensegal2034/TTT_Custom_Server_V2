if SERVER then
	...
	resource.AddFile("materials/vgui/entities/harpoon.vtf")
	resource.AddFile("materials/vgui/entities/m9k_harpoon.vmt")
	resource.AddFile("materials/vgui/hud/harpoon.vtf")
	resource.AddFile("materials/vgui/hud/m9k_harpoon.vmt")
	resource.AddFile("materials/vgui/ttt/tttharpoonicon.png")
	resource.AddFile("materials/pincher.vmt")
	resource.AddFile("materials/refract_ring.vmt")
	resource.AddFile("materials/refract_ring.vtf")
	resource.AddFile("models/weapons/v_invisib.mdl")
	resource.AddFile("models/weapons/v_invisible_nade.mdl")
	resource.AddFile("models/weapons/w_harpooner.mdl")
	resource.AddFile("particles/nitro_main.pcf")
...
SWEP.IronSightsPos = Vector(0, 0, 90)
...
SWEP.WElements = {
	["WHarpoon"] = { type = "Model", model = "models/props_junk/harpoon002a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2, 0, -2), angle = Angle(-10, 270, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
