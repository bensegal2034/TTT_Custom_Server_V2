...
if SERVER then
   ...
   resource.AddFile("materials/vgui/ttt/icon_dete_player_cam.png")
end

-- swep settings
SWEP.HoldType              = "pistol"
if CLIENT then
	SWEP.PrintName          = "Playercam"
	SWEP.Slot               = 6
	...
	SWEP.EquipMenuData = {
		type = "item_weapon",
		desc = "\nShows the vision of hit target\nAmmo will be refunded on closing window, allowing for a new target"
	};
