if SERVER then
    ...
    resource.AddFile("models/jalopy/body_front.mdl")
    resource.AddFile("models/jalopy/body_jalopy.mdl")
    resource.AddFile("models/jalopy/baggage.mdl")
    resource.AddFile("models/jalopy/bumper_back.mdl")
    resource.AddFile("models/jalopy/extaus.mdl")
    resource.AddFile("models/jalopy/front_bumper.mdl")
    resource.AddFile("models/jalopy/jalope_rad.mdl")
    resource.AddFile("models/jalopy/roof_jalopy.mdl")
    resource.AddFile("models/jalopy/st_wheel.mdl")
    resource.AddFile("models/jalopy/wheel front.mdl")
    resource.AddFile("models/jalopy/wheel_right.mdl")
    resource.AddFile("models/vehicle/jalopytempnormal.vtf")
    resource.AddFile("models/vehicle/mining_car.vtf")
    resource.AddFile("models/vehicle/musclecar_col.vtf")
    resource.AddFile("models/vehicle/musclecar_dash_col.vtf")
    resource.AddFile("models/vehicle/musclecar_engine_col.vtf")
    resource.AddFile("models/vehicle/musclecar_engine_normal.vtf")
    resource.AddFile("models/vehicle/musclecar_normal.vtf")
    resource.AddFile("models/vehicle/musclecar_specexponent.vtf")
    resource.AddFile("models/vehicle/vehicle_ambocc.vtf")
    resource.AddFile("models/airboat_base.mdl")
    resource.AddFile("models/airboat_cab.mdl")
    resource.AddFile("models/airboat_engine.mdl")
    resource.AddFile("models/airboat_fanbase.mdl")
    resource.AddFile("models/airboat_frame.mdl")
    resource.AddFile("models/airboat_gun_physics.mdl")
    resource.AddFile("models/airboat_nose.mdl")
    resource.AddFile("models/airboat_pontoon.mdl")
    resource.AddFile("models/airboat_propeller.mdl")
    resource.AddFile("models/airboat_rudder.mdl")
    resource.AddFile("models/airboat_steering.mdl")
    resource.AddFile("models/ammo_box.mdl")
    resource.AddFile("models/buggy_ammo_box.mdl")
    resource.AddFile("models/buggy_base.mdl")
    resource.AddFile("models/buggy_front.mdl")
    resource.AddFile("models/buggy_front_wheel.mdl")
    resource.AddFile("models/buggy_meter.mdl")
    resource.AddFile("models/buggy_rear_wheel.mdl")
    resource.AddFile("models/buggy_roof.mdl")
    resource.AddFile("models/buggy_steering.mdl")
    resource.AddFile("models/buggy_tau.mdl")
