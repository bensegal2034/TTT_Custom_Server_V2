if SERVER then
   ...
   resource.AddFile( "sound/weapons/tfa_csgo/negev/negev_boxin.wav" )
   resource.AddFile( "sound/weapons/tfa_csgo/negev/negev_boxout.wav" )
   resource.AddFile( "sound/weapons/tfa_csgo/negev/negev_chain.wav" )
   resource.AddFile( "sound/weapons/tfa_csgo/negev/negev_coverdown.wav" )
   resource.AddFile( "sound/weapons/tfa_csgo/negev/negev_coverup.wav" )
   resource.AddFile( "sound/weapons/tfa_csgo/negev/negev_draw.wav" )
   resource.AddFile( "sound/weapons/tfa_csgo/negev/negev_clean_01.wav" )
   resource.AddFile( "sound/weapons/tfa_csgo/negev/negev_pump.wav" )
   resource.AddFile( "sound/weapons/tfa_csgo/negev/negev-x-1.wav" )
   resource.AddFile( "models/weapons/tfa_csgo/c_hands_translator.mdl")
   resource.AddFile( "models/weapons/tfa_csgo/c_mach_negev.mdl" )
   ...
   resource.AddFile( "materials/models/tfa_csgo/negev/mach_negev_normal.vmt" )
