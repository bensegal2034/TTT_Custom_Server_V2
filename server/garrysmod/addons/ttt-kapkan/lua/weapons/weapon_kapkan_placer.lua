AddCSLuaFile()
if SERVER then
	resource.AddWorkshop("3520946367")
end

SWEP.Base = "weapon_base"

SWEP.PrintName = "Entry Denial Device"
SWEP.EquipMenuData = {
		type = "Weapon",
		desc = "Packed C4 charge activated when motion is detected. \nIt should be placed on door and window frames, \n To deny key entry points for hostiles."
   };
