...
resource.AddFile("materials/VGUI/ttt/icon_redmatter.vmt")
...
SWEP.WorldModel			= "models/jenssons/props/redmatter.mdl"
SWEP.Weight				= 5
...
if CLIENT then
   -- Path to the icon material
	...
	if file.Exists("materials/VGUI/ttt/icon_redmatter.vmt", "GAME") then
		SWEP.Icon = "VGUI/ttt/icon_redmatter"
	else
   ...
   -- Text shown in the equip menu
	SWEP.EquipMenuData = {
		...
		type = "Weapon",
		desc = "Red Matter Bomb.\n Releases A black hole."
   };
